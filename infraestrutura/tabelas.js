class Tabelas {
    ...
    criarLojas(){
        const sql = 'CREATE TABLE IF NOT EXISTS Lojas (id_loja serial PRIMARY KEY NOT NULL, nome_loja varchar(50) NOT NULL, info_loja varchar(200), destaque_loja boolean NOT NULL, image_loja varchar(255) NOT NULL, createdAt timestamp, updatedAt timestamp, deletedAt timestamp)'
